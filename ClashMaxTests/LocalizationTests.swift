...
final class LocalizationTests: XCTestCase {
  ...
  func testSimplifiedChineseStringCatalogProvidesRepresentativeSettingsKeys() throws {
    ...
    XCTAssertEqual(zhBundle.localizedString(forKey: "macOS already uses this shortcut.", value: nil, table: nil), "macOS 已占用该快捷键。")
    XCTAssertEqual(zhBundle.localizedString(forKey: "Some global shortcuts will not work: %@", value: nil, table: nil), "部分全局快捷键将无法生效：%@")
